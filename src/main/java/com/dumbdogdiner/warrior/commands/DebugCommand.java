...
import com.dumbdogdiner.warrior.api.sound.SoundEffect;
...
public class DebugCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        ...
        SoundEffect fluteSound = new SoundEffect(InstrumentSound.fromInstrument(Instrument.DIDGERIDOO), 2f, Note.C2)
                                    .repeat(24, 1L)
                                    .descending();

        fluteSound.play(user.getBukkitPlayer());
