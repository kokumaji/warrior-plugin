<<<<<<< Updated upstream:warrior-api/src/main/java/com/dumbdogdiner/warrior/api/kit/Kit.java
...
import me.kokumaji.warrior.api.events.WarriorKitEquipEvent;
import me.kokumaji.warrior.api.util.json.JSONHelper;
import me.kokumaji.warrior.api.util.json.JSONModel;
import me.kokumaji.warrior.api.util.json.JsonSerializable;
import me.kokumaji.warrior.api.util.json.models.KitModel;
import me.kokumaji.warrior.api.user.WarriorUser;
>>>>>>> Stashed changes:warrior-api/src/main/java/me/kokumaji/warrior/api/kit/Kit.java
...
public interface Kit extends JsonSerializable {
    ...
    @NotNull WarriorKitEnums getKitEnum();
